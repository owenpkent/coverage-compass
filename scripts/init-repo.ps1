...
Write-Host "  1. Create an empty GitHub repo. Suggested name: coverage-compass."
Write-Host "       Do NOT initialize it with README, LICENSE, or .gitignore."
Write-Host "  2. Add the remote:"
Write-Host "       git remote add origin git@github.com:<your-user>/coverage-compass.git"
Write-Host "  3. Push:"
