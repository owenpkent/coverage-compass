...
- `SECURITY.md`: vulnerability reporting now uses GitHub's [private vulnerability reporting](https://github.com/owenpkent/ccdc-medicaid-tool/security/advisories/new) feature.
